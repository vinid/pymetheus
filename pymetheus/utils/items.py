...
from pymetheus.utils.fuzzy_models import *
import tqdm
import random
...
class LogiNet:
    ...
    def add_predicate(self, predicate, arity=2, size = 20):
        """
    ...
    def add_constant(self, name, definition=None, size=20):
        """
        ...
        if name in self.constants:
            logging.info("New declaration for old constant " + name)
    ...
    def train(self, data_vars, epoch=100, sampling_rate=30):
        criterion = nn.BCELoss()
        learning_rate = 0.01
